...
exports.multicallAddresses = exports.functionSignatureMatcher = exports.abi = exports.MulticallVersion = void 0;
var MulticallVersion;
(function (MulticallVersion) {
    MulticallVersion[MulticallVersion["V1"] = 1] = "V1";
    MulticallVersion[MulticallVersion["V2"] = 2] = "V2";
...
exports.functionSignatureMatcher = /function\s+(?<signature>\w+)/;
