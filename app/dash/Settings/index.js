      ...
      <div className={'localSettings cardShow'}>
        <div className='localSettingsWrap'>
          <div className='signerPermission localSetting' style={{ zIndex: 214 }}>
            ...
            <div className='signerPermissionDetails'>
              <KeyboardShortcutConfigurator
                actionText='summon EvoTradeWallet'
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 213 }}>
            ...
            <div className='signerPermissionDetails'>
              <span>Hide EvoTradeWallet on loss of focus</span>
            </div>
          </div>
          <div className='signerPermission localSetting' style={{ zIndex: 212 }}>
            ...
            <div className='signerPermissionDetails'>Run EvoTradeWallet when your computer starts</div>
          </div>
          <div className='signerPermission localSetting' style={{ zIndex: 211 }}>
            ...
            <div className='signerPermissionDetails'>{"Mouse to display's right edge to summon EvoTradeWallet"}</div>
          </div>
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 209 }}>
            ...
            <div className='signerPermissionDetails'>
              <span>Help improve EvoTradeWallet by anonymously reporting errors</span>
            </div>
          </div>
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 199 }}>
            ...
            <div className='signerPermissionDetails'>When should EvoTradeWallet relock your hot signers?</div>
          </div>
        </div>
      </div>
    )
